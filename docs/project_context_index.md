...
> 版本：v1.2
> 更新时间：2026-09-07（v1.2：生产已上线 `9e8578a`——daemon 调度 active、归一/去重完成（旧 MD5 行合计 80130 行）、唯一索引与 v2 列就位；执行记录见 `docs/production_update_ops_2026-09-07.md` §8；**飞书推送已确认停用（用户决策），非故障**）
